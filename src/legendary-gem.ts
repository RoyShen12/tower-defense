...
class BaneOfTheStricken extends GemBase {
  ...
  static readonly maxLevel = Infinity
...
class ZeisStoneOfVengeance extends GemBase {
  ...
  static readonly baseDamageMakingRatioMax = 1.20
...
class BrokenPieces extends GemBase {
  ...
  static readonly baseArmorDecreaseStrength = 0.02

  static readonly armorDecreaseStrengthLevelMx = 0.0001

  static readonly baseExtraArmorBasedDamageRatio = 0.5

  static readonly extraArmorBasedDamageRatioLevelMx = 0.05
