...
PainEnhancer.baseBleedDamageRatio = 800;
PainEnhancer.bleedDamageRatioLevelMx = 100;
...
SimplicitysStrength.gemName = '力量精魄';
SimplicitysStrength.price = 18000;
SimplicitysStrength.maxLevel = 5000;
...
SimplicitysStrength.baseAttackAddition = 0.75;
SimplicitysStrength.attackAdditionLevelMx = 0.1;
...
MirinaeTeardropOfTheStarweaver.gemName = '星辰之泪';
...
BaneOfTheStricken.maxLevel = Infinity;
...
ZeisStoneOfVengeance.gemName = '猎手之魂';
...
class BrokenPieces extends GemBase {
    ...
    damageHook() { }
    static get stasisDescription() {
        return `每次击中都能摧毁敌人 ${Tools.roundWithFixed(this.baseArmorDecreaseStrength * 100, 0)}%（+${Tools.roundWithFixed(this.armorDecreaseStrengthLevelMx * 100, 2)}%/等级）的护甲，` +
...
BrokenPieces.baseArmorDecreaseStrength = 0.02;
BrokenPieces.armorDecreaseStrengthLevelMx = 0.0001;
BrokenPieces.baseExtraArmorBasedDamageRatio = 0.5;
BrokenPieces.extraArmorBasedDamageRatioLevelMx = 0.05;
var _a, _b, _c;
class Tools {
...
class ImageManger {
    ...
    loadImages() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const resArr = yield Promise.all(loadTasks);
            resArr.forEach(res => {
