...
let GemOfMysterious = function (_GemBase7) {
  _inherits(GemOfMysterious, _GemBase7);

  _createClass(GemOfMysterious, null, [{
    key: "gemName",
    get: function () {
      return '秘法宝石';
    }
    ...
    key: "basePointAddition",
    get: function () {
      return 4000;
    }
  }, {
    key: "pointAdditionLevelMx",
    get: function () {
      return 500;
    }
  }, {
  ...
  function GemOfMysterious() {
    var _this7;

    _classCallCheck(this, GemOfMysterious);

    _this7 = _possibleConstructorReturn(this, _getPrototypeOf(GemOfMysterious).call(this));
    _this7.tower = null;
    return _this7;
  }

  _createClass(GemOfMysterious, [{
    key: "initEffect",
    value: function initEffect(thisTower) {
      this.tower = thisTower;
    ...
    key: "levelUp",
    value: function levelUp(currentPoint) {
      const ret = _get(_getPrototypeOf(GemOfMysterious.prototype), "levelUp", this).call(this, currentPoint);
  ...
  return GemOfMysterious;
}(GemBase);

let BaneOfTheTrapped = function (_GemBase8) {
  _inherits(BaneOfTheTrapped, _GemBase8);
  ...
  function BaneOfTheTrapped() {
    ...
    _this8 = _possibleConstructorReturn(this, _getPrototypeOf(BaneOfTheTrapped).call(this));
    _this8.tower = null;
    return _this8;
  }
...
let ZeisStoneOfVengeance = function (_GemBase9) {
  _inherits(ZeisStoneOfVengeance, _GemBase9);
  ...
  function ZeisStoneOfVengeance() {
    ...
    _this9 = _possibleConstructorReturn(this, _getPrototypeOf(ZeisStoneOfVengeance).call(this));
    _this9.tower = null;
    return _this9;
  }
...
let EchoOfLight = function (_GemBase10) {
  _inherits(EchoOfLight, _GemBase10);
...
let GemOfAnger = function (_GemBase11) {
  _inherits(GemOfAnger, _GemBase11);

  _createClass(GemOfAnger, null, [{
    key: "gemName",
    get: function () {
      return '愤怒宝石';
    }
  ...
  function GemOfAnger() {
    _classCallCheck(this, GemOfAnger);

    return _possibleConstructorReturn(this, _getPrototypeOf(GemOfAnger).call(this));
  }

  _createClass(GemOfAnger, [{
    key: "tickHook",
    value: function tickHook(thisTower, monsters) {
